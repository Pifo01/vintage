...
from .filtro import TIPO_CHOICES, COLOR_CHOICES, GENERO_CHOICES, TALLAS_CHOICES
...
class Articulos(models.Model):
    ...
    marca = models.ForeignKey(Marca, on_delete=models.CASCADE, default=1, null=False)
