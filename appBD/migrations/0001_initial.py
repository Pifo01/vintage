# Generated by Django 3.1 on 2024-11-07 17:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('deportivo', 'Deportivo'), ('casual', 'Casual'), ('formal', 'Formal')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='DatosUsuario',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.ImageField(upload_to='imagenes/')),
                ('marca', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='appBD.marca')),
            ],
        ),
        migrations.AddField(
            model_name='articulos',
            name='marca',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='appBD.marca'),
        ),
    ]
